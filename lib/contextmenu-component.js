...
export default class ContextMenu extends Component {
    ...
    handleCustomAction = (item) => {
        invoke(['customActionHandler'], item, this.props);
    };
    ...
    getSubMenus = () => {
        if (this.props.filterFlattenSubMenus) {
            return this.props.filterFlattenSubMenus(this.props.items);
        }
    ...
    popover = () => {
        return <Popover className="context-menu" id="context-menu-popover">
            {this.buildMenus(this.getSubMenus())}
        </Popover>;
    };
